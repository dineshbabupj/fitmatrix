...
- Name: calculators.spec.ts >> FitMetrics Web E2E >> should navigate to BMI calculator and show inputs
- Location: e2e\calculators.spec.ts:17:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8085/calculators/bmi
Call log:
  - navigating to "http://localhost:8085/calculators/bmi", waiting until "load"
